...
def train_evaluate(ga_individual_solution): 
	...
	print('\nnum of epochs = ',n_epoch,"num_neurons = [",neuron1,",",neuron2,",",neuron3,"]","window size = ",look_back)
...
def genetic():
	...
	toolbox.register('mutate', tools.mutUniformInt,low = [100,1,1,1,1],up = [2000,5,5,5,6],indpb = 0.6)
	...
	for bi in best_individuals:
		...
		best_neuron3 = bi[3]
		best_window = bi[4]
		print("epochs = ",best_epochs,",neurons = [",best_neuron1,",",best_neuron2,",",best_neuron3,"]", ",window size = ",best_window)
