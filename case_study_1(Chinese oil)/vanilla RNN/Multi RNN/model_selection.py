...
def train_evaluate(ga_individual_solution): 
	...
	print('\nnum of epochs = ',n_epoch,", neurons = [",neuron1,",",neuron2,",",neuron3,"]","window size = ",look_back)
...
def genetic():
	...
	for bi in best_individuals:
		...
		print('\n epochs = ',best_epochs,", neurons = [",best_neuron1,",",best_neuron2,",",best_neuron3,"]","window size = ",best_window)
