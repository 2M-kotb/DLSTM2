...
def train_evaluate(ga_individual_solution): 
	...
	#neuron2 = ga_individual_solution[1]
	#neuron3 = ga_individual_solution[2]
	look_back = ga_individual_solution[2]
	

	print('\nnum of epochs = ',n_epoch,", neurons = ",neuron1,"window size = ",look_back)
...
def genetic():
	...
	toolbox.register('mutate', tools.mutUniformInt,low = [100,1,1],up = [2000,5,6],indpb = 0.6)
	...
	for bi in best_individuals:
		...
		print('\n epochs = ',best_epochs,", neurons = ",best_neuron1,"window size = ",best_window)
